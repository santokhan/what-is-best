...
export default function NavBar() {
  ...
  return (
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded relative ">
      <div className="max-w-screen-xl px-4 flex flex-wrap items-center justify-between mx-auto">
        ...
        {drop ? (
          <div className="absolute left-0 top-full w-full h-screen bg-white z-50">
            <ul className="flex flex-col p-4 mt-4 rounded-lg md:flex-row md:space-x-8 md:mt-0 md: md:font-medium md:border-0 bg-white">
              <NLink href="/">Home</NLink>
              <NLink href="/about">About</NLink>
              <NLink href="/explore">Explore</NLink>
            </ul>
