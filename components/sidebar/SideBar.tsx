...
export default function SideBar({ children }: Props) {
  ...
  useEffect(() => {
    window.onscroll = () => {
      ...
      console.log(scrollH);
      if (scrollH > window.innerHeight + 600) {
        setsticky(true);
      } else {
        setsticky(false);
      }
  ...
  return (
    <div>
      <aside className={"w-full lg:w-[320px] first-line:"}>
      ...
      {sticky ? (
        <aside
          className={"w-full lg:w-[320px] fixed left top-0 hidden lg:block "}
        >
          <div className="bg-gray-50 px-8 lg:py-8">
            <div>
